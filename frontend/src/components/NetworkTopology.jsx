...
export default function NetworkTopology({
  ...
  useEffect(() => {
    ...
    filteredNodes.forEach(node => {
      ...
      const labelName = node.name || node.label || node.id;
  ...
  return (
    <div className="canvas-container" style={{ position: 'relative', width: '100%', height: '540px', minHeight: '400px' }}>
      ...
      {/* FLOATING GRAPH FILTERS & LEGEND OVERLAY PANEL */}
      <div style={{
        position: 'absolute',
        top: '12px',
        right: '12px',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          ...
          <button
            ...
            title={showFiltersPanel ? "Collapse Filters & Legend" : "Expand Filters & Legend"}
          >
            {showFiltersPanel ? '▲' : '▼'}
          </button>
        </div>
        ...
        {showFiltersPanel && (
          <div>
            ...
            <div style={{ marginBottom: '12px' }}>
              ...
              <select
                value={entityFilter}
                onChange={(e) => onEntityFilterChange && onEntityFilterChange(e.target.value)}
                style={{
                  width: '100%',
                  padding: '6px 10px',
                  borderRadius: '6px',
            ...
            <div style={{ marginBottom: '14px' }}>
              ...
              <input
                ...
                step="5"
                value={threatFilter}
                onChange={(e) => onThreatFilterChange && onThreatFilterChange(parseInt(e.target.value))}
            ...
            <div style={{ background: '#f8fafc', padding: '10px 12px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
              <div style={{ fontSize: '10px', fontWeight: 800, color: '#0f172a', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                NODE COLOR REPRESENTATION
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '11px', fontWeight: 600, color: '#334155' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#991b1b', display: 'inline-block' }}></span>
